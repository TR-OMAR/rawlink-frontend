      ...
      <div className="listing-detail-layout">
        ...
        <div className="listing-detail-info">
          ...
          <div className="listing-meta-grid">
            <div className="meta-item"><span className="meta-item-label">Category</span><span className="meta-item-value">{listing.category}</span></div>
            <div className="meta-item"><span className="meta-item-label">Available</span><span className="meta-item-value">{listing.quantity} {listing.unit}</span></div>
            <div className="meta-item"><span className="meta-item-label">Location</span><span className="meta-item-value">{listing.location}</span></div>
            <div className="meta-item"><span className="meta-item-label">Vendor</span><span className="meta-item-value">{listing.vendor}</span></div>
          </div>
