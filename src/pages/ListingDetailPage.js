...
function ListingDetailPage() {
  ...
  const confirmOrder = () => createOrderMutation.mutate();
        ...
        <div className="listing-detail-info">
          ...
          <div className="listing-meta-grid">
            ...
            <div className="meta-item">
              ...
              <span className="meta-item-value">{getCountryName(listing.country) || 'Not specified'}</span>
            </div>
            <div className="meta-item">
              <span className="meta-item-label">City</span>
              <span className="meta-item-value">{listing.city || 'Not specified'}</span>
            </div>
            <div className="meta-item" style={{ gridColumn: 'span 2' }}>
              <span className="meta-item-label">Full Address / Location</span>
              <span className="meta-item-value">{listing.location || 'Not specified'}</span>
            </div>
            <div className="meta-item">
